...
namespace Auto.AuditLog
{
    class Program
    {
        ...
        {
            var csv =
                $"{message.FirstName},{message.MiddleName},{message.LastName},{message.Age},{message.Experience},{message.Serial},{message.Number},{message.RegCodeVehicle},{message.CreatedAt}";
        ...
        {
            var csv =
                $"{message.Serial}-{message.Number},old:{message.OldVehicle},new:{message.NewVehicle},{message.CreatedAt}";
            Console.WriteLine(csv);
        }
